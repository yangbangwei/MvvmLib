...
import com.yangbw.libtest.ui.dialog.LoginDialog
import com.yangbw.libtest.ui.viewmodel.LoginViewModel
    ...
    override fun init(savedInstanceState: Bundle?) {
        mBinding.run {
            ...
            tvPhone.text = (buildString {
                append(mPhone.substring(0, 3))
                append("****")
                append(mPhone.substring(7))
            })
